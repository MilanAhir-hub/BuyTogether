                    ...
                    {properties.map((property) => (
                        ...
                        >
                            <div className="relative h-64 overflow-hidden">
                                ...
                                />
                                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur block px-3 py-1 rounded-full text-xs font-semibold text-slate-900">
                                    Pre-Launch
                                </div>
                            </div>
                            <div className="p-6">
                                ...
                                <div className="flex justify-between items-center mt-6 pt-6 border-t border-slate-100">
                                    ...
                                    <button className="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-900 text-sm font-semibold rounded-lg transition-colors">
                                        View Details
                                    </button>
                                </div>
                            </div>
