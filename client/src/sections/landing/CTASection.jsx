...
const CTASection = () => {
    return (
        <section className="py-24 bg-linear-to-br from-slate-900 to-blue-900 overflow-hidden relative">
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500 rounded-xl mix-blend-multiply filter blur-3xl opacity-20 -translate-y-1/2 translate-x-1/2"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500 rounded-xl mix-blend-multiply filter blur-3xl opacity-20 translate-y-1/2 -translate-x-1/2"></div>
