      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="shrink-0 flex items-center">
            <a href="/home" className="font-bold text-xl text-gray-900 tracking-tight">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <div className="h-8 w-8 rounded-none bg-indigo-100 flex items-center justify-center text-indigo-600 font-semibold text-sm">
                  U
                </div>
          ...
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            <div className="border-t border-gray-100 my-2 pt-2 pb-1">
              <div className="px-3 flex items-center mt-2 mb-3">
                 <div className="h-10 w-10 rounded-none bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-lg mr-3">
                  U
                </div>
                <div>
