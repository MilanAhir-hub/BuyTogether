  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-['Inter']">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="rounded-xl overflow-hidden h-[350px] lg:h-[450px] shadow-sm relative group border border-gray-100">
          <img
          ...
          <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl shadow-lg border border-white/20 flex flex-col items-center">
            <div className="h-10 w-10 bg-sky-100 text-sky-600 rounded-xl flex items-center justify-center mb-1 shadow-inner relative">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors">
                <div className="flex items-center">
                  <div className="bg-orange-50 p-2 rounded-xl text-orange-600 mr-3">
              ...
              <li className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors">
                <div className="flex items-center">
                  <div className="bg-blue-50 p-2 rounded-xl text-sky-600 mr-3">
              ...
              <li className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors">
                <div className="flex items-center">
                  <div className="bg-red-50 p-2 rounded-xl text-red-600 mr-3">
              ...
              <li className="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors">
                <div className="flex items-center">
                  <div className="bg-purple-50 p-2 rounded-xl text-purple-600 mr-3">
