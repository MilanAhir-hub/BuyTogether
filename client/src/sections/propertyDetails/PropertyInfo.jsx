    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 font-['Inter']">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sticky top-24 transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            <h3 className="text-lg font-bold text-gray-900 mb-6 border-b border-gray-100 pb-4">Key Specifications</h3>
            
            <ul className="space-y-5">
              <li className="flex items-start">
                <div className="bg-sky-50 p-2.5 rounded-xl mr-4 shrink-0 text-sky-600">
              ...
              <li className="flex items-start">
                <div className="bg-blue-50 p-2.5 rounded-xl mr-4 shrink-0 text-sky-600">
              ...
              <li className="flex items-start">
                <div className="bg-emerald-50 p-2.5 rounded-xl mr-4 shrink-0 text-emerald-600">
              ...
              <li className="flex items-start">
                <div className="bg-amber-50 p-2.5 rounded-xl mr-4 shrink-0 text-amber-600">
              ...
              <li className="flex items-start">
                <div className="bg-rose-50 p-2.5 rounded-xl mr-4 shrink-0 text-rose-600">
