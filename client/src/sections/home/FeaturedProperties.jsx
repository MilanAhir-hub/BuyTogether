  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <a href="#" className="hidden sm:inline-flex items-center text-sky-600 font-medium hover:text-blue-700 hover:underline transition-all">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {properties.map((property) => {
          ...
          return (
            <div key={property.id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group flex flex-col h-full">
              ...
              <div className="relative h-48 sm:h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-xl text-xs font-bold text-green-600 shadow-sm">
                  Available
                </div>
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  <div className="w-full bg-gray-100 rounded-xl h-2 mb-5 overflow-hidden">
                    <div 
                      className="bg-blue-500 h-2 rounded-xl transition-all duration-1000 ease-in-out" 
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button className="py-2.5 px-3 bg-sky-600 text-white rounded-xl text-sm font-semibold hover:bg-blue-700 hover:shadow-md transition-all text-center">
                      Join Group
                    </button>
                  </div>
                </div>
      ...
      <div className="mt-6 text-center sm:hidden">
        <a href="#" className="inline-flex items-center text-sky-600 font-medium hover:text-blue-700 transition-all">
