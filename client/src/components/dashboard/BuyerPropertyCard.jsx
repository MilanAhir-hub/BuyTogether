...
const BuyerPropertyCard = ({ property }) => {
    return (
        <article className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_80px_rgba(15,23,42,0.10)]">
            <div className="relative h-56 overflow-hidden bg-[linear-gradient(135deg,#dbeafe_0%,#eef2ff_50%,#f8fafc_100%)]">
                ...
                <div className="absolute left-5 top-5 inline-flex rounded-xl bg-white/92 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-slate-700 shadow-sm">
