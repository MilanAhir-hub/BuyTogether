    ...
    return (
        <div className="min-h-screen bg-white pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {steps.map((step, index) => (
                        <div key={index} className="relative group p-8 rounded-xl border border-gray-100 hover:border-primary/20 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 bg-white">
                            <div className={`w-16 h-16 ${step.bg} rounded-xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}>
                                {step.icon}
                            </div>
            ...
            <div className="max-w-5xl mx-auto px-6 mt-32 text-center">
                <div className="bg-secondary text-white rounded-xl p-12 md:p-20 overflow-hidden relative">
