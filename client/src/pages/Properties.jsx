        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-bg-light border-b border-gray-100 py-16 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex w-full md:w-auto items-center bg-white rounded-xl border border-gray-200 px-6 py-3 shadow-sm focus-within:border-primary transition-all">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-10">
                <div className="flex items-center gap-4 overflow-x-auto pb-4 no-scrollbar">
                    <div className="flex items-center gap-2 bg-secondary text-white px-4 py-2.5 rounded-xl text-sm font-medium mr-4">
                        <FilterIcon size={18} />
                        Filters
                    </div>
                    {filters.map((filter) => (
            ...
            <div className="max-w-7xl mx-auto px-6 mt-12 mb-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {mockProperties.map((property) => (
                        <div key={property.id} className="group flex flex-col bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500">
                            {/* Image Container */}
                            <div className="relative h-64 overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4 flex gap-2">
                                    <span className="bg-white/90 backdrop-blur-md px-3 py-1 rounded-xl text-[11px] font-bold text-secondary uppercase tracking-wider">
                                        {property.category}
                                    </span>
                                    <span className="bg-primary px-3 py-1 rounded-xl text-[11px] font-bold text-white uppercase tracking-wider shadow-lg shadow-primary/20">
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50">
                                    <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 rounded-xl bg-bg-light flex items-center justify-center text-primary">
