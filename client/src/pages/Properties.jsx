        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-bg-light border-b border-gray-100 py-16 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex w-full md:w-auto items-center bg-white rounded-full border border-gray-200 px-6 py-3 shadow-sm focus-within:border-primary transition-all">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-10">
                <div className="flex items-center gap-4 overflow-x-auto pb-4 no-scrollbar">
                    <div className="flex items-center gap-2 bg-secondary text-white px-4 py-2.5 rounded-full text-sm font-medium mr-4">
                        <FilterIcon size={18} />
                        Filters
                    </div>
                    {filters.map((filter) => (
