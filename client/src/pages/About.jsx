    ...
    return (
        <div className="min-h-screen bg-white pb-20">
            ...
            <div className="relative pt-24 pb-32 px-6 overflow-hidden bg-bg-light">
                <div className="absolute top-20 left-1/4 w-96 h-96 bg-primary/10 rounded-xl blur-[120px] -z-10"></div>
                <div className="absolute bottom-10 right-1/4 w-80 h-80 bg-primary-light/10 rounded-xl blur-[100px] -z-10"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {stats.map((stat, index) => (
                        <div key={index} className="bg-white p-8 rounded-xl shadow-xl shadow-primary/5 border border-gray-100 text-center">
                            <div className="w-12 h-12 bg-bg-light rounded-xl flex items-center justify-center text-primary mx-auto mb-4">
                                {stat.icon}
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 mt-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="space-y-8">
                            {values.map((value, index) => (
                                <div key={index} className="flex gap-6">
                                    <div className="shrink-0 w-14 h-14 bg-secondary text-white rounded-xl flex items-center justify-center">
                                        {value.icon}
                                    </div>
                                    <div>
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute -bottom-10 -left-10 bg-primary p-10 rounded-xl shadow-xl shadow-primary/30 max-w-[280px] hidden md:block">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-40">
                <div className="bg-linear-to-r from-primary to-primary-light p-1 rounded-xl">
                    <div className="bg-white rounded-xl p-12 md:p-20 text-center">
